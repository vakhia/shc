            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 ">
                    <div class="department-block mb-5">
                        <img src="{{asset('assets/main/images/service/department.jpeg')}}" alt="" class="img-fluid w-100">
                        <div class="content">
                            <h4 class="mt-4 mb-2 title-color">{{$department->title}}</h4>
                            <p class="mb-4">{{$department->description}}</p>
                            <a href="{{route('main.department.show',$department->id)}}" class="read-more">Learn More  <i class="icofont-simple-right ml-2"></i></a>
                        </div>
                    </div>
                </div>
                @endforeach()
